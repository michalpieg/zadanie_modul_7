...
fig = px.pie(same_cluster_df, names="fav_animals", title="Rozkład ulubionych zwierząt w grupie")
st.plotly_chart(fig)

fig = px.pie(same_cluster_df, names="fav_place", title="Rozkład ulubionych miejsc w grupie")
st.plotly_chart(fig)
